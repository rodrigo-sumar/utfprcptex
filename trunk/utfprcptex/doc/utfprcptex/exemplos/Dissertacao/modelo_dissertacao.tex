...
%%
%%
\documentclass[twoside,openright]{utfprcptex} %openright = o capitulo comeca sempre em paginas impares
...
%\usepackage[left=3.0cm,right=2cm,top=3cm,bottom=2cm,a4paper]{geometry}
...
\titulo{\MakeUppercase{T\'itulo em Portugu\^es sdsd dsdsd sddsds dsdsd sdsdsd dsdsds}} % titulo do trabalho em portugues
...
\folhaderosto[comficha] % geracao automatica da folha de rosto
